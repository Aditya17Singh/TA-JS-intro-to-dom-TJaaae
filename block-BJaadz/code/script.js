...
for(let elm of allHrsArray){
  elm.style.border = "1px dashed tomato"
}
...
to.append("Append inserts as last child")
// Select box 3 and prepend a new paragraph element with content "Prepend inserts as first child" just before hr element.
let pre = document.querySelector(".three")
pre.prepend("Prepend inserts as first child")
// Change the border of box 4 to '1px solid black'
let bord = document.querySelector(".four")
bord.style.border = "1px solid black"
// Change the border radius of box 5 to 10px.
let rad = document.querySelector(".five")
rad.style.borderRadius = "10px"
// Change the text color of box 6 to black.
let col = document.querySelector(".six")
